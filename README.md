## EMERGENCY BROADCAST VIS-ÀVIS INCOMING FIRST RESPONDER USING RECEIVED SIGNAL STRENGTHINDICATOR (RSSI) AND MODIFIEDAD HOC ON DEMAND VECTOR (MAODV) ON BLUETOOTH NETWORK: SIMULATION
